...
% fins and rudders
rudders=translate(rotateZ(scale(UnitSphere(2),.75,1.5,.2),45),4,1,1);
rudders.facecolor = [0,0,0];
rudders2=translate(rotateZ(scale(UnitSphere(2),.75,1.5,.2),-45),4,-1,1);
rudders2.facecolor = [0,0,0];
rudders3=translate(rotateZ(scale(UnitSphere(2),.75,1.5,.2),-45),-4,1,1);
rudders3.facecolor = [0,0,0];
rudders4=translate(rotateZ(scale(UnitSphere(2),.75,1.5,.2),45),-4,-1,1);
rudders4.facecolor = [0,0,0];
thrusters = combine(rudders, rudders2, rudders3, rudders4);
...
motorprop1 = combine(motors, prop);

auv = combine(thrusters, fuselage);
