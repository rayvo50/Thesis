...
%annotation('arrow', [16, 12], [2, 2], 'Color', 'G', 'LineWidth', 2, 'HeadStyle', 'cback2', 'HeadLength', 10, 'HeadWidth', 10);
%text(text_x, text_y, 'Important Trend', 'HorizontalAlignment', 'center', 'Color', 'r', 'FontSize', 12);
...
print(fig, '../../imagens_pic/xy_ua.png', '-dpng', '-r300'); 
...
print(fig, '../../imagens_pic/yaw_ua.png', '-dpng', '-r300'); 
...
set(gcf, 'Position', [100, 100, 600, 200]); 
print(fig, '../../imagens_pic/uv_ua.png', '-dpng', '-r300'); 
...
xlim([min(t), max(t) ])
set(gcf, 'Position', [100, 100, 600, 200]);
print(fig, '../../imagens_pic/filter_error_ua.png', '-dpng', '-r300'); 
...
set(gcf, 'Position', [100, 100, 600, 200]); 
print(fig, '../../imagens_pic/cross_track_ua.png', '-dpng', '-r300'); 

% heading error
fig = figure();hold on; grid on;
a = find(state==2);
error1 = 180/pi*wrapToPi(pi-x1(3,a)+Pd(3));
plot(t1(a),error1, Color=[0,0,0], LineWidth=2) 
error2 = 180/pi*wrapToPi(pi-x2(3,a)+Pd(3));
plot(t2(a),error2, Color=[0.7647 0.0549 0], LineWidth=2) 
legend('No Current','Current 0.2 m/s', 'Location', 'best'); 
...
set(gcf, 'Position', [100, 100, 600, 200]); 
print(fig, '../../imagens_pic/alignment_error_ua.png', '-dpng', '-r300'); 
